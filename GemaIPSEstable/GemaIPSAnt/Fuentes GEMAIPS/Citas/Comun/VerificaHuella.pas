...
QryGeneral.Close;
  ...
  QryGeneral.SQL.Add(' (rtrim(P.PRIMER_APELLIDO)+ '+chr(39)+' '+chr(39)+ ' + rtrim(P.SEGUNDO_APELLIDO)+ '+chr(39)+' '+chr(39)+' + rtrim(P.PRIMER_NOMBRE)+ '+chr(39)+' '+chr(39)+' + rtrim(P.SEGUNDO_NOMBRE)) as Nombre');
  ...
  QryGeneral.SQL.Add(' (rtrim(P.PRIMER_APELLIDO)+ '+chr(39)+' '+chr(39)+ ' + rtrim(P.SEGUNDO_APELLIDO)+ '+chr(39)+' '+chr(39)+' + rtrim(P.PRIMER_NOMBRE)+ '+chr(39)+' '+chr(39)+' + rtrim(P.SEGUNDO_NOMBRE)) ');
