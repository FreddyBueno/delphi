object FrmLibroAuxiliarTercero: TFrmLibroAuxiliarTercero
  Left = 308
  Top = 120
  BorderStyle = bsDialog
  Caption = 'Libro Auxiliar por Tercero'
  ClientHeight = 203
  ClientWidth = 523
  Color = clBtnFace
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
      ...
      '              contdetcomp.Tercero like :Cta AND'
      '              contenccomp.Estado='#39'G'#39
      'ORDER BY contdetcomp.Tercero, contenccomp.Fecha_Comprobante')
    Left = 430
    Top = 9
  end
  ...
  object ADOQuery5: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT Periodo_Proceso,Tercero,sum(Saldo_Debito) as Saldo_Debito' +
        ',sum(Saldo_Credito) as Saldo_Credito'
      'FROM CONTSaldo,ContTerce'
      
        'WHERE ContSaldo.Tercero = Contterce.Numero_Documento+ contterce.' +
        'sucursal  AND'
      '               periodo_proceso=:per AND '
      '               contsaldo.tercero =:cta'
      'GROUP BY Periodo_Proceso,Tercero'
      ' ')
    Left = 462
    Top = 9
  end
