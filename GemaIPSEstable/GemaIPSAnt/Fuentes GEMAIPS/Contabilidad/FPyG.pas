...
procedure TFormPyG.Button1Click(Sender: TObject);
begin
...
procedure TFormPyG.FormCreate(Sender: TObject);
begin
  adoquery3.Open;
end;

procedure TFormPyG.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  action:=cafree;
end;

procedure TFormPyG.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
  var st : currency;
begin
   ADOQTot1.Close;
