object FrmLibroAuxiliarxCtaResumen: TFrmLibroAuxiliarxCtaResumen
  Left = 355
  Top = 138
  BorderStyle = bsDialog
  Caption = 'Libro Auxiliar por Cuenta Consolidado por Comprobante'
  ClientHeight = 210
  ClientWidth = 522
  Color = clBtnFace
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        'ce.Nombre AS Nombre,contcuenta.naturaleza as naturaleza'
  ...
  object ADOQuery2: TADOQuery
    ...
    SQL.Strings = (
      'SELECT Sum(Valor_Debito) AS Vrd, Sum(Valor_Credito) AS Vrc'
        ...
        'ccomp.Numero_Comprobante) AND (contdetcomp.Tipo_Comprobante = co' +
        'ntenccomp.Tipo_Comprobante)) ON contcuenta.Cuenta = contdetcomp.' +
        'Cuenta) ON contterce.Numero_Documento = contdetcomp.Cuenta'
      'WHERE contenccomp.Periodo_Proceso like  :Per  AND '
      '              contdetcomp.cuenta like :Cta AND'
      '              contenccomp.Estado='#39'G'#39)
    Left = 400
