...
type
  TFrmLibroAuxiliarTercero = class(TForm)
    QuickRep1: TQuickRep;
...
var
  FrmLibroAuxiliarTercero: TFrmLibroAuxiliarTercero;
...
procedure TFrmLibroAuxiliarTercero.FormCreate(Sender: TObject);
begin
    adoquery3.Open;
    adoquery4.Open;
    ADOQuery6.Open;
...
procedure TFrmLibroAuxiliarTercero.CheckBox1Click(Sender: TObject);
begin
...
procedure TFrmLibroAuxiliarTercero.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
Action :=  caFree;
end;

procedure TFrmLibroAuxiliarTercero.Button1Click(Sender: TObject);
begin
  ...
  Begin
    ...
    ADOQuery5.Parameters.ParamValues['Cta']:=ADOQuery1.FieldValues['Tercero'];
    ADOQuery5.Open;
...
procedure TFrmLibroAuxiliarTercero.QRGroup1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  ADOquery5.Close;
  ADOQuery5.Parameters.ParamValues['Per']:=Mes_Anterior;
...
procedure TFrmLibroAuxiliarTercero.QRFooterBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  ADOquery5.Close;
...
procedure TFrmLibroAuxiliarTercero.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
