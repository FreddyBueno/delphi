...
var
  FormPyGTercero: TFormPyGTercero;
  Saldo,saldo2:Double;
...
procedure TFormPyGTercero.Button1Click(Sender: TObject);
begin
 ...
 begin
   ...
   ADOQuery1.Open;
   if FormPyGTercero.Caption='      P y G' then
   Begin
...
procedure TFormPyGTercero.FormCreate(Sender: TObject);
begin
  adoquery3.Open;
end;

procedure TFormPyGTercero.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  action:=cafree;
end;

procedure TFormPyGTercero.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
  var st : currency;
begin
   ADOQTot1.Close;
   ...
   ADOQTot1.Open;
   if ADOQtot1.FieldValues['tot'] <> null then
