object FTabContables: TFTabContables
  Left = 259
  Top = 143
  Caption = 'Informaci'#243'n Contable por Subcuenta'
  ClientHeight = 565
  ClientWidth = 1044
  Color = clBtnFace
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT CONTCuenta.Cuenta+'#39' '#39'+CONTCuenta.Descripcion as cta,Perio' +
        'do_Proceso,naturaleza,sum(valor_Debito) as Debito,sum(Valor_Cred' +
        'ito)  as Credito'
      'FROM CONTEncComp,CONTDetComp,CONTCuenta'
        ...
        'bante) AND '
      '      left(CONTDetComp.Cuenta,:nv) = CONTCuenta.Cuenta AND'
      '      CONTEncComp.Estado = '#39'G'#39' AND'
      '      CONTCuenta.Cuenta Like :tp AND'
      '      Periodo_Proceso like :per AND'
      '      CONTDetComp.Tercero like :Ter AND'
      '      CONTEncComp.Tipo_Comprobante like :tpcom'
      
        'GROUP BY CONTCuenta.Cuenta+'#39' '#39'+CONTCuenta.Descripcion,Periodo_Pr' +
        'oceso,naturaleza'
      
        'ORDER BY CONTCuenta.Cuenta+'#39' '#39'+CONTCuenta.Descripcion,Periodo_Pr' +
        'oceso,naturaleza')
    Left = 268
    Top = 48
  end
  ...
  object ADOQuerySaldo: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT CONTCuenta.Cuenta+'#39' '#39'+CONTCuenta.Descripcion as cta,Perio' +
        'do_Proceso,naturaleza,sum(Saldo_Debito) as Debito,sum(Saldo_Cred' +
        'ito)  as Credito'
      'FROM CONTSaldo,CONTCuenta'
      'WHERE left(CONTSaldo.Cuenta,:nv) = CONTCuenta.Cuenta AND'
      '      CONTCuenta.Cuenta Like :tp AND'
      '      Periodo_Proceso like :per AND'
      '      CONTSaldo.Tercero like :Ter AND'
