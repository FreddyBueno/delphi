object HomologaPaquetePush: THomologaPaquetePush
  Left = 298
  Top = 89
  BorderStyle = bsSingle
  Caption = 'Homologaci'#243'n de Paquete vs Cuentas Contables'
  ClientHeight = 515
  ClientWidth = 860
  Color = clBtnFace
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
      ...
      'FROM CRAgrupacion'
        ...
        'WHERE (CRAgrupacion.Cuenta NOT IN (SELECT CONTCuenta.Cuenta FROM' +
        ' CONTCuenta WHERE CONTCuenta.Estado = '#39'A'#39') OR'
      '      CRAgrupacion.Cuenta = '#39#39') ')
    Left = 181
    Top = 294
  end
