object FrmLibroAuxiliarxTipoComp: TFrmLibroAuxiliarxTipoComp
  Left = 483
  Top = 182
  BorderStyle = bsDialog
  Caption = 'Libro Auxiliar por Tipo de Comprobante'
  ClientHeight = 210
  ClientWidth = 522
  Color = clBtnFace
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT conttipocomp.Descripcion as desccomp, contenccomp.empresa' +
        ' as empresa,contenccomp.area as area,contenccomp.Tipo_Comprobant' +
        'e, contenccomp.Numero_Comprobante, contenccomp.Fecha_Comprobante' +
        ', contenccomp.Descripcion, contenccomp.Periodo_Proceso, contdetc' +
        'omp.Cuenta AS Cuenta, contdetcomp.Tercero AS Tercero, contdetcom' +
        'p.Centro_Costo AS Centro_Costo, contdetcomp.Valor_Debito AS Valo' +
        'r_Debito, contdetcomp.Valor_Credito AS Valor_Credito, contcuenta' +
        '.Descripcion AS Descripcion_1, contterce.Primer_Apellido AS Nomb' +
        're,contcuenta.naturaleza as naturaleza'
      ...
      '              contenccomp.Estado='#39'G'#39
        ...
        'ORDER BY contenccomp.Tipo_Comprobante, contenccomp.Fecha_Comprob' +
        'ante')
    Left = 430
    Top = 9
  end
