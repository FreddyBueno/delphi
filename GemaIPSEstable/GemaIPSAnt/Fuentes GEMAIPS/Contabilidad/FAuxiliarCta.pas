...
type
  TFrmLibroAuxiliarxCta = class(TForm)
    QuickRep1: TQuickRep;
...
var
  FrmLibroAuxiliarxCta: TFrmLibroAuxiliarxCta;
...
procedure TFrmLibroAuxiliarxCta.FormCreate(Sender: TObject);
begin
    adoquery3.Open;
    adoquery4.Open;
    ADOQuery6.Open;
...
procedure TFrmLibroAuxiliarxCta.CheckBox1Click(Sender: TObject);
begin
...
procedure TFrmLibroAuxiliarxCta.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
Action :=  caFree;
end;

procedure TFrmLibroAuxiliarxCta.Button1Click(Sender: TObject);
begin
...
procedure TFrmLibroAuxiliarxCta.QRGroup1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  ADOquery5.Close;
  ADOQuery5.Parameters.ParamValues['Per']:=Mes_Anterior;
...
procedure TFrmLibroAuxiliarxCta.QRFooterBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  ADOquery5.Close;
...
procedure TFrmLibroAuxiliarxCta.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
