object FImprimeFacturaSmall2: TFImprimeFacturaSmall2
  Left = 355
  Top = 80
  BorderStyle = bsToolWindow
  Caption = 'Impresi'#243'n Factura Tipo Tira '
  ClientHeight = 324
  ClientWidth = 522
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object DateTimePicker1: TDateTimePicker
      ...
      Width = 241
      Height = 25
      Date = 40303.427609189800000000
      Time = 40303.427609189800000000
      TabOrder = 5
      TabStop = False
    ...
    object GroupBox1: TGroupBox
      ...
      object CheckBox2: TCheckBox
        ...
        Width = 185
        Height = 17
        Caption = 'Incluye la Agrupaci'#243'n.'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
      ...
      object CheckBox3: TCheckBox
        ...
        Width = 185
        Height = 17
        Caption = 'Incluye el Detalle de Paquetes.'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
      ...
      object CheckBox4: TCheckBox
        ...
        Width = 185
        Height = 17
        Caption = 'Incluye el Detalle Quirurgico.'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
      ...
      object CheckBox5: TCheckBox
        ...
        Width = 185
        Height = 17
        Caption = 'Incluye la Observaci'#243'n Secundaria.'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
      ...
      object CheckBox6: TCheckBox
        ...
        Width = 185
        Height = 17
        Caption = 'Agrupa Codigos Iguales.'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
  ...
  object DataSource1: TDataSource
    DataSet = ADOQueryFacD
    Left = 288
    Top = 48
  end
  object ADOQueryFacD: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT Empresa+Numero_Factura as cod,Empresa,Numero_Factura,Fech' +
        'a,Cliente,Vendedor,Valor_Subtotal,Valor_Descuento,Valor_IVA,Valo' +
        'r_Total,Numero_Comprobante_Contable,Descripcion,Estado,Pagada_To' +
        'tal,Fec_Vence,Fec_Radicacion,Fec_ProbablePago,Codigo,Descripcion' +
        '_Emp,Nit,Ciudad,Direccion,Telefono,Observ,Consecutivo,Codigo_Sal' +
        'ud '
      'FROM INENCFacturacion left outer join Comunes.dbo.SEEmpresas on'
      'INEncFacturacion.empresa = Comunes.dbo.SEEmpresas.Codigo'
      'WHERE  INEncFacturacion.empresa = :Emp'
      '   AND Fecha >= convert(DateTime, :fec )'
      'ORDER BY Empresa,Numero_Factura DESC')
    Left = 320
    Top = 48
  end
  object ADOTableCF: TADOTable
    Connection = DataModule1.ADOConnection1
  ...
  object DataSource3: TDataSource
    DataSet = ADOQueryFacH
    Left = 288
    Top = 80
  end
  object ADOQueryFacH: TADOQuery
    Connection = DataModule1.ADOConnection1
    CursorType = ctStatic
    Parameters = <
      item
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT  INENCFacturacion.Empresa, INENCFacturacion.Numero_Factur' +
        'a,Tipo_PST,Agrupacion, INENCFacturacion.Fecha,Cliente, '
      #9'Vendedor, Codigo_Producto,Cantidad, Valor_Unitario,'
      #9'INDETFacturacion.Valor_Total AS Valor_Total_1, '
      
        #9'INDetFacturacion.Nombre AS Nombrexx, INENCFacturacion.Valor_Sub' +
        'total,Valor_Conceptos,   '
      
        #9'INENCFacturacion.Valor_Descuento,INENCFacturacion.Valor_Total, ' +
        'INENCFacturacion.Valor_Total - INENCFacturacion.Valor_Descuento ' +
        'as TotalDscto, ((INENCFacturacion.Valor_Total - INENCFacturacion' +
        '.Valor_Descuento)*16)/100 as Valor_IVA,'
      
        #9'INENCFacturacion.Descripcion  AS descf2,  fec_vence, fec_radica' +
        'cion,CREncCargos.No_Admision,'
      
        '                TP_Admision,CCHistoria,SAPacientes.Primer_Apelli' +
        'do,SAPacientes.Segundo_Apellido,SAPacientes.Primer_Nombre,SAPaci' +
        'entes.Segundo_Nombre,Fec_Admision,Fec_Egreso,'
      
        '                 INDetFacturacion.Descripcion as DescDet,INEncFa' +
        'cturacion.No_Contrato, INENCFacturacion.Estado,Vendedor+'#39' - '#39'+CO' +
        'NTTerce.Primer_Apellido + '#39' '#39'+ CONTTerce.Primer_Nombre as NomVen' +
        'dedor'
      'FROM INENCFacturacion   '
      
        'inner join INDETFacturacion on  (INENCFacturacion.Empresa  = IND' +
        'ETFacturacion.Empresa AND '
      
        #9#9#9#9#9#9#9#9' INENCFacturacion.Numero_Factura = INDETFacturacion.Nume' +
        'ro_Factura )'
      
        'left outer join CONTTerce on INEncFacturacion.Vendedor = CONTTer' +
        'ce.Numero_Documento'
      
        'left outer join CREncCargos on INDetFacturacion.No_Cargo= CREncC' +
        'argos.No_Cargo '
      
        'inner join SAAdmisiones on CREncCargos.No_Admision = SAAdmisione' +
        's.No_Admision'
      
        'inner join SAPacientes on ( SAAdmisiones.tp_Ident_Usuar = SAPaci' +
        'entes.Tp_Ident_Usuar AND'
      
        #9#9#9#9#9#9#9'SAAdmisiones.Nr_Ident_Usuar = SAPacientes.Nr_Ident_Usuar ' +
        ')'
      'WHERE INENCFacturacion.Numero_Factura  >= :nfac  AND '
      '      INENCFacturacion.Numero_Factura  <= :nfac1  AND'
      '      INENCFacturacion.Empresa                 = :emp'
      
        'ORDER BY INENCFacturacion.Empresa,INENCFacturacion.Numero_Factur' +
        'a,CREncCargos.No_Admision,Tipo_PST,Agrupacion,Codigo_Producto')
    Left = 3
    Top = 288
  end
  object ADOQuery2: TADOQuery
    ...
    SQL.Strings = (
      'SELECT *'
      'FROM INDETFacturacionConcepto,CAConceptos'
      
        'WHERE INDETFacturacionConcepto.Concepto = CAConceptos.Concepto A' +
        'ND'
      '      empresa = :emp AND'
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.CreateDate = 41876.461409513890000000
    ReportOptions.LastChange = 41876.461409513890000000
