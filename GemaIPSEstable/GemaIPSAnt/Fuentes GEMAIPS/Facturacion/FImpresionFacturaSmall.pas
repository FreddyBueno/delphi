...
type
  TFImprimeFacturaSmall = class(TForm)
    Panel1: TPanel;
    Label1: TLabel;
...
var
  FImprimeFacturaSmall: TFImprimeFacturaSmall;
...
procedure TFImprimeFacturaSmall.FormClose(Sender: TObject; var Action: TCloseAction);
begin
      Action :=  caFree;
end;

procedure TFImprimeFacturaSmall.FormActivate(Sender: TObject);
begin
  adoqueryEmp.Open;
...
procedure TFImprimeFacturaSmall.SpeedButton2Click(Sender: TObject);
var rt : real;
begin
...
procedure TFImprimeFacturaSmall.Edit1Change(Sender: TObject);
begin
...
procedure TFImprimeFacturaSmall.DBLookupComboBox2Exit(Sender: TObject);
begin
  adoqueryFacD.Close;
...
procedure TFImprimeFacturaSmall.Edit2Change(Sender: TObject);
begin
...
procedure TFImprimeFacturaSmall.FormCreate(Sender: TObject);
begin
  DateTimePicker1.DateTime := now -30;
end;

procedure TFImprimeFacturaSmall.DateTimePicker1Exit(Sender: TObject);
begin
  adoqueryFacD.Close;
  adoqueryFacD.Parameters.ParamValues['Emp']:=ADOQueryEmp.FieldValues['Codigo'];
  adoqueryFacD.Parameters.ParamValues['Fec']:=DateTimePicker1.DateTime;
...
procedure TFImprimeFacturaSmall.DBLookupComboBox1Exit(Sender: TObject);
begin
  DBLookupComboBox3.KeyValue := DBLookupComboBox1.KeyValue;
end;

procedure TFImprimeFacturaSmall.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var valor:currency;
Begin
end;

procedure TFImprimeFacturaSmall.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
 c1:=0;
 c2:=0;
...
procedure TFImprimeFacturaSmall.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  //QRLabel57.Caption := Format('%16.2n',[c4]);
end;

procedure TFImprimeFacturaSmall.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TFImprimeFacturaSmall.QRBand1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  c2:=0;
end;

procedure TFImprimeFacturaSmall.QRBand2AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  c4:=0;
end;

procedure TFImprimeFacturaSmall.QRBand3AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  c6:=0;
end;

procedure TFImprimeFacturaSmall.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  //QRLabel59.Caption := Format('%16.2n',[c6]);
end;

procedure TFImprimeFacturaSmall.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  //QRLabel55.Caption := Format('%16.2n',[c2]);
end;

procedure TFImprimeFacturaSmall.QRGroup1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var Valor:currency;
begin
  ...
  ADOQtmp.Close;
  ADOQtmp.SQL.Clear;
  ADOQtmp.SQL.Add('SELECT * FROM CONTTerce WHERE Numero_Documento = left('+chr(39)+ADOQuery1.FieldValues['Cliente']+chr(39)+',len(Numero_Documento))');
  ADOQtmp.Open;
  ...
  //QRLabel10.Caption := Format('%16.2n',[Valor]);
end;

procedure TFImprimeFacturaSmall.QRBand5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TFImprimeFacturaSmall.QRBand6AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
 c1:=0;
 c3:=0;
...
procedure TFImprimeFacturaSmall.QRBand6BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
