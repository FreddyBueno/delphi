...
type
  TFImprimeFacturaSmall2 = class(TForm)
    Panel1: TPanel;
    Label1: TLabel;
...
var
  FImprimeFacturaSmall2: TFImprimeFacturaSmall2;
...
procedure TFImprimeFacturaSmall2.FormClose(Sender: TObject; var Action: TCloseAction);
begin
      Action :=  caFree;
end;

procedure TFImprimeFacturaSmall2.FormActivate(Sender: TObject);
begin
  adoqueryEmp.Open;
...
procedure TFImprimeFacturaSmall2.SpeedButton2Click(Sender: TObject);
var rt : real;
begin
...
procedure TFImprimeFacturaSmall2.Edit1Change(Sender: TObject);
begin
...
procedure TFImprimeFacturaSmall2.DBLookupComboBox2Exit(Sender: TObject);
begin
  adoqueryFacD.Close;
...
procedure TFImprimeFacturaSmall2.Edit2Change(Sender: TObject);
begin
...
procedure TFImprimeFacturaSmall2.FormCreate(Sender: TObject);
begin
  DateTimePicker1.DateTime := now -30;
end;

procedure TFImprimeFacturaSmall2.DateTimePicker1Exit(Sender: TObject);
begin
  adoqueryFacD.Close;
  adoqueryFacD.Parameters.ParamValues['Emp']:=ADOQueryEmp.FieldValues['Codigo'];
  adoqueryFacD.Parameters.ParamValues['Fec']:=DateTimePicker1.DateTime;
...
procedure TFImprimeFacturaSmall2.DBLookupComboBox1Exit(Sender: TObject);
begin
  DBLookupComboBox3.KeyValue := DBLookupComboBox1.KeyValue;
end;

procedure TFImprimeFacturaSmall2.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var valor:currency;
Begin
end;

procedure TFImprimeFacturaSmall2.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
 c1:=0;
 c2:=0;
...
procedure TFImprimeFacturaSmall2.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  //QRLabel57.Caption := Format('%16.2n',[c4]);
end;

procedure TFImprimeFacturaSmall2.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TFImprimeFacturaSmall2.QRBand1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  c2:=0;
end;

procedure TFImprimeFacturaSmall2.QRBand2AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  c4:=0;
end;

procedure TFImprimeFacturaSmall2.QRBand3AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  c6:=0;
end;

procedure TFImprimeFacturaSmall2.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  //QRLabel59.Caption := Format('%16.2n',[c6]);
end;

procedure TFImprimeFacturaSmall2.QRGroup1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var Valor:currency;
begin
  ...
  ADOQtmp.Close;
  ADOQtmp.SQL.Clear;
  ADOQtmp.SQL.Add('SELECT * FROM CONTTerce WHERE Numero_Documento = '+chr(39)+ADOQuery1.FieldValues['Cliente']+chr(39));
  ADOQtmp.Open;
...
procedure TFImprimeFacturaSmall2.QRBand5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TFImprimeFacturaSmall2.QRBand6AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
 c1:=0;
 c3:=0;
...
procedure TFImprimeFacturaSmall2.QRBand6BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
