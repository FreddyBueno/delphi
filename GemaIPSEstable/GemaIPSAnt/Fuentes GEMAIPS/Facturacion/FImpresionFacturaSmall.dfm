object FImprimeFacturaSmall: TFImprimeFacturaSmall
  Left = 355
  Top = 80
  BorderStyle = bsToolWindow
  Caption = 'Impresi'#243'n Factura Small'
  ClientHeight = 339
  ClientWidth = 556
  Color = clBtnFace
  ...
  object ADOQueryFacD: TADOQuery
    ...
    SQL.Strings = (
        ...
        '            Numero_Comprobante_Contable,Descripcion,Estado,Pagad' +
        'a_Total,Fec_Vence,Fec_Radicacion,Fec_ProbablePago,Codigo,Descrip' +
        'cion_Emp,Nit,Ciudad,Direccion,Telefono,Observ,Consecutivo,Codigo' +
        '_Salud '
  ...
  object ADOQueryFacH: TADOQuery
    ...
    SQL.Strings = (
        ...
        '        Numero_Comprobante_Contable,Descripcion,Estado,Pagada_To' +
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
      ...
      #9'INDETFacturacion.Valor_Total AS Valor_Total_1, '
        ...
        #9'INENCFacturacion.Valor_Descuento, INENCFacturacion.Valor_IVA,IN' +
        'ENCFacturacion.Valor_Total,Valor_Conceptos,  '
      
        #9'INENCFacturacion.Descripcion  AS descf2,  fec_vence, fec_radica' +
        'cion,CREncCargos.No_Admision,'
      
        '                TP_Admision,CCHistoria,Primer_Apellido,Segundo_A' +
        'pellido,Primer_Nombre,Segundo_Nombre,Fec_Admision,Fec_Egreso,'
      
        '                 INDetFacturacion.Descripcion as DescDet,SAAdmis' +
        'iones.No_Contrato, INENCFacturacion.Estado'
      'FROM INENCFacturacion '
      
        'inner join INDETFacturacion on ( INENCFacturacion.Empresa  = IND' +
        'ETFacturacion.Empresa AND '
      
        #9#9#9#9#9#9#9#9' INENCFacturacion.Numero_Factura    = INDETFacturacion.N' +
        'umero_Factura )'
      
        'left outer join CREncCargos on INDetFacturacion.No_Cargo = CREnc' +
        'Cargos.No_Cargo'
  ...
  object ADOQuery2: TADOQuery
    ...
    SQL.Strings = (
      'SELECT *'
      'FROM CADetFacturas,CAConceptos'
      'WHERE CADetFacturas.Concepto = CAConceptos.Concepto AND'
      '             empresa = :emp AND'
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.CreateDate = 41876.460934027770000000
    ReportOptions.LastChange = 41876.460934027770000000
