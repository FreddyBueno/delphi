...
begin
cmdgen4505.Connection:=datamodule1.ADOConnection1;
 tblReg1.Open;
 tblReg2.Open;
 edtFechaInicial.Date:=Now;
 edtFechaFinal.Date:=Now;
 edtFechaInicial.Properties.MaxDate:=now;
 edtFechaFinal.Properties.MaxDate:=now;
 //edtFechaInicial.Date:=tblReg1.FieldByName('E3').value;
 //edtFechaFinal.Date:=tblReg1.FieldByName('E4').value;
end;
