object FrmHojaAdmision: TFrmHojaAdmision
  Left = 366
  Top = 155
  BorderStyle = bsDialog
  Caption = 'Hoja de Admisi'#243'n'
  ClientHeight = 209
  ClientWidth = 345
  Color = clBtnFace
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        ' SELECT *,convert(integer,(getdate()-fec_Nacimineto))/365 as Eda' +
        'dC,SATiposAdmision.Descripcion as DescTpAdm,'
      #9#9'comunes.dbo.GEEstados_Civiles.Descripcion AS DescEstCiv,'
      '        GeRegimen.nom_tipo as desctpreg,'
      '        GETipoAfiliado.Nom_Tipo as desctpafil'
      ''
      'FROM SAAdmisiones'
      ''
      
        '         inner join SAPacientes on (SAAdmisiones.Tp_Ident_Usuar ' +
        '= SAPacientes.Tp_Ident_Usuar'
      
        '        '#9#9'  AND  SAAdmisiones.Nr_Ident_Usuar = SAPacientes.Nr_Id' +
        'ent_Usuar)'
      ''
      
        '         left outer join SAMedicos on (SAAdmisiones.Tp_Ident_Med' +
        'ico = SAMedicos.Tp_Ident_Medico'
      
        '        '#9#9'  AND  SAAdmisiones.Nr_Ident_Medico = SAMedicos.Nr_Ide' +
        'nt_Medico )'
      ''
      
        '         left outer join SATiposAdmision on (SAAdmisiones.Tp_Adm' +
        'ision = SATiposAdmision.CD_Tipo_Admision)'
      ''
      
        '         left outer join comunes.dbo.GENacionalidad on (SAPacien' +
        'tes.Nacionalidad = comunes.dbo.GENacionalidad.Cod_Nacionalida)'
      ''
      
        '         left outer join comunes.dbo.GEEstados_Civiles on (SAPac' +
        'ientes.Estado_Civil = comunes.dbo.GEEstados_Civiles.Codigo)'
      ''
      
        '         left outer join comunes.dbo.GESexo on (SAPacientes.sexo' +
        ' = comunes.dbo.GESexo.Tip_Sexo )'
      ''
      
        '         left outer join comunes.dbo.GEMunicipios on (SAPaciente' +
        's.Cod_Municipio = comunes.dbo.GEMunicipios.Cd_Municipio'
      
        '        '#9#9'  AND SAPacientes.Cod_Departamento = comunes..GEMunici' +
        'pios.CD_Departamento )'
      ''
      
        '         left outer join comunes.dbo.GEDepartamentos on (SAPacie' +
        'ntes.Cod_Departamento = comunes.dbo.GEDepartamentos.CD_Departame' +
        'nto )'
      ''
      
        '         left outer join GETipoAfiliado  on  (SAPacientes.Tp_Afi' +
        'liado = GETipoAfiliado.Cod_Tipo )'
      ''
      ''
      
        '         left outer join GERegimen on   (SAPacientes.tp_usuario ' +
        '= GERegimen.Cod_Tipo )'
      ''
      'where SAAdmisiones.No_Admision = :NoAdmi')
    Left = 96
    Top = 6
  end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.CreateDate = 41876.447571331020000000
    ReportOptions.LastChange = 41876.447571331020000000
