object FrmHojaAdmisionSmall2: TFrmHojaAdmisionSmall2
  Left = 342
  Top = 29
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT *,convert(integer,(getdate()-fec_Nacimineto))/365 as Edad' +
        'C,CITipos_Citas.Descripcion As DescCon,GESecciones.Descripcion A' +
        's DescSecc,GETiposCama.Descripcion AS DescTpCma,'
      
        '            CRDetCargos.Valor_Liquidado+((CRDetCargos.Valor_Liqu' +
        'idado * 16)/100) as TotLiqconIVA,round(Valor_Liquidado,2) as Val' +
        'or_LiquidadoR,CRDetCargos.Precio*CRDetCargos.Unidades as VRTotal'
      'FROM SAAdmisiones'
      ''
      ...
      '       SAAdmisiones.Nr_Ident_Usuar = SAPacientes.Nr_Ident_Usuar)'
        ...
        'inner join CREncCargos on SAAdmisiones.No_Admision = CREncCargos' +
        '.No_Admision'
      
        'inner join CRDetCargos on CREncCargos.No_Cargo = CRDetCargos.No_' +
        'Cargo'
      ''
      
        'LEFT outer join SAMedicos on (SAAdmisiones.Tp_Ident_Medico = SAM' +
        'edicos.Tp_Ident_Medico AND '
      '       SAAdmisiones.Nr_Ident_Medico = SAMedicos.Nr_Ident_Medico)'
      
        'LEFT outer join CONTTerce on SAAdmisiones.Aseguradora = CONTTerc' +
        'e.Numero_Documento'
      
        'LEFT outer join CITipos_Citas on SAAdmisiones.Tip_Consulta =CITi' +
        'pos_Citas.Tipo_Cita'
      
        'LEFT outer join GESecciones on SAAdmisiones.Tip_Seccion  =GESecc' +
        'iones.Cd_Seccion'
      
        'LEFT outer join GETiposCama on  SAAdmisiones.Tip_Consultorio  = ' +
        'GETiposCama.cd_Tipo'
      
        'LEFT outer join comunes.dbo.GEMunicipios on (SAPacientes.Cod_Mun' +
        'icipio = comunes.dbo.GEMunicipios.Cd_Municipio AND'
      
        '       SAPacientes.Cod_Departamento = comunes.dbo.GEMunicipios.C' +
        'D_Departamento)'
      
        'LEFT outer join comunes.dbo.GEDepartamentos on SAPacientes.Cod_D' +
        'epartamento = comunes.dbo.GEDepartamentos.CD_Departamento'
      
        'WHERE CREncCargos.Estado is NULL AND CREncCargos.No_Cargo= :NoSo' +
        'l ')
    Left = 280
    Top = 65534
  end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.CreateDate = 41876.449650856480000000
    ReportOptions.LastChange = 41876.449650856480000000
